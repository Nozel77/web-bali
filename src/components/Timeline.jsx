    ...
    return (
        ...
        <div className="col-span-4 w-full h-full"></div>
            ...
            <div className="w-full h-full bg-gray-700 rounded-md p-2 md:pl-4">
                ...
                <p className="text-gray-100 sm:text-sm text-xs">
                elanda berhasil menjajah Bali setelah perang Puputan Badung pada
                tahun ini.
                </p>
                ...
                <p className="text-gray-100 sm:text-sm text-xs">
                Bali berperan dalam perjuangan kemerdekaan Indonesia dengan
                perlawanan terhadap Belanda selama Perang Kemerdekaan Indonesia.
                </p>
                ...
                <p className="text-gray-100 sm:text-sm text-xs">
                Setelah kemerdekaan Indonesia pada tahun ini, Bali menjadi bagian
            ...
            <div className="w-full h-full bg-gray-700 rounded-md p-2 md:pl-4">
                ...
                <p className="text-gray-100 sm:text-sm text-xs">
                Pada tahun 1970-an, Bali mulai menjadi destinasi pariwisata
                terkenal di dunia.
                </p>
                ...
                <p className="text-gray-100 sm:text-sm text-xs">
                Bali mengalami serangan teroris pada tahun 2002 dan 2005, yang
                ...
                <p className="text-gray-100 sm:text-sm text-xs">
                Bali terus berkembang dalam berbagai sektor, termasuk ekonomi,
                seni, dan budaya, dengan budaya Bali yang terus berkembang dan
                dihargai secara global.
                </p>
            </div>
            </div>
        </div>
